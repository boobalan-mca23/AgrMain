...
const ReceiptPrintReport=(props)=>{
    ...
    const {fromDate,toDate,customerName,receipt}=props
  return(
       <>
         <div>
            <div>
                <h1 style={styles.title}>Receipt Voucher Report</h1>
            </div>
                       ...
                       <tbody>
                           {receipt.map((item,index)=>(
                            <tr>
                                ...
                                <td style={styles.ReportTablebody}>{item.goldRate||0}</td>
                                ...
                                <td style={styles.ReportTablebody}>{item.hallMark||0}</td>
                            </tr>
                           ))}
                        </tbody> 
                     </table>    
